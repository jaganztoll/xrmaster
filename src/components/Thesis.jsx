                ...
                <div className="max-w-4xl mx-auto text-center flex items-center">
                    <div className="text-xl font-medium">
                        ...
                        <a href="https://drive.google.com/file/d/198y-KvVVpTpE-H1s-8tqHfH0-xBlzWzx/view"
                            ...
                            className="text-xl underline underline-offset-3 decoration-1 text-[var(--text)] hover:text-[var(--accent)] ml-1">
                            Masterarbeit
                        </a>
                        <DiGoogleDrive className="inline w-10 h-10 fill-[var(--text)] align-[-12px] transition-colors duration-300" />
                    </div>
                </div>
            </Element>
        </section>
